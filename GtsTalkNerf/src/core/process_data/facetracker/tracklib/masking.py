...
class Masking(nn.Module):
    def __init__(self):
        ...
        with open(f'{dir}/../../../data/FLAME2020/FLAME_masks/FLAME_masks.pkl', 'rb') as f:
        ...
        self.color_mesh = trimesh.load(f'{dir}/../../../data/FLAME2020/head_template_color.obj', process=False)
