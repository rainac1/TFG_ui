...
from tracklib.flame.lbs import lbs
...
class FLAME(nn.Module):
    ...
    def __init__(self, config):
        ...
        mediapipe_lmk_embedding = np.load('tracklib/flame/mediapipe/mediapipe_landmark_embedding.npz', allow_pickle=True, encoding='latin1')
