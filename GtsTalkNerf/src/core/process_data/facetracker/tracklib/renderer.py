...
import utils.trackutil as util
from tracklib.masking import Masking
from tracklib.tracker_rasterizer import TrackerRasterizer
...
class Renderer(nn.Module):
    def __init__(self, image_size, obj_filename, uv_size=512, flip=False):
        ...
        mask = torch.from_numpy(imread('../../data/FLAME2020/uv_mask_eyes.png') / 255.).permute(2, 0, 1).cuda()[0:3, :, :]
        mask = mask > 0.
