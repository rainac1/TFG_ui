...
class Validator(object):
    def __init__(self, trainer):
        ...
        # nfc = micautil.find_model_using_name(model_dir='nfclib.models', model_name=self.cfg.model.name)(self.cfg, self.device)
    ...
    def run(self):
        with torch.no_grad():
            ...
            if self.trainer.global_step % (self.cfg.train.val_steps * 5) == 0:
                ...
                # micautil.save_embedding_projection(embeddings, os.path.join(self.cfg.output_dir, self.cfg.train.val_vis_dir, f'{self.trainer.global_step:08}_embeddings.jpg'))
                self.embeddings_lyhm = {}
            ...
            micautil.visualize_grid(visdict, savepath, size=512)
